...
import ECollectionCreateForm from './ECustomizedForm';
import EFormTable from './EFormTable';
...
export default class EForm extends Component{
    ...
    //getData
    getData = () => {
        var apiURL = "/sm/employee/employee";
        var opts = {
            credentials: "include",
            method: "GET",
            headers: {
    ...
    onDelete = (employeeId) => {
        ...
        this.setState({ dataSource: dataSource.filter(item => item.employeeId !== employeeId) });
    ...
    editClick = (employeeId) => {
        const form = this.form;
        const { dataSource } = this.state;
        const index = catchIndex(dataSource, employeeId);
        console.log(employeeId);
        form.setFieldsValue({
        ...
        return(
            <div>
                ...
                <div className='formBody'>
                    ...
                    />
                    {isUpdate?
                        <ECollectionCreateForm ref={this.saveFormRef} visible={visible} onCancel={this.handleCancel} onCreate={this.handleUpdate} title="Update Info" okText="update"
                        /> : <ECollectionCreateForm ref={this.saveFormRef} visible={visible} onCancel={this.handleCancel} onCreate={this.handleCreate} title="Create Info" okText="create"
                        />}
                </div>
            </div>
        )
